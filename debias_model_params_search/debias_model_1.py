...
def init_trainer(model_name: str, train_data: Dataset, val_data: Dataset, alpha = 0.1, beta = 0.1, output_dir = "./checkpoints_debias", num_labels=3) -> Trainer:
...
if __name__ == "__main__":  # Use this script to train your model
    ...
    alpha = 0.1
    beta = 0.1
    output_dir = 'checkpoints_debias_1'
    trainer = init_trainer(model_name, split["train"], split["val"], alpha=alpha, beta=beta, output_dir=output_dir)
